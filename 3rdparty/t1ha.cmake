if (USE_HASH_ALGORITHM_T1HA2)
        ...
        if(ARCH_IS_X86_64)
                ...
                set_source_files_properties(
                        ...
                        "-mno-avx512f -mno-avx256-split-unaligned-load -maes -mavx2 -mbmi -mbmi2 -mfma -mtune=haswell")
                ...
                set_source_files_properties(
                        ...
                        PROPERTIES COMPILE_FLAGS
                        "-mno-avx512f -mno-avx256-split-unaligned-load -mno-avx2 -mavx -mbmi -mbmi2 -maes")
                ...
                set_source_files_properties(
                        ...
                        PROPERTIES COMPILE_FLAGS
                        "-mno-avx512f -mno-avx256-split-unaligned-load -mno-avx2 -mno-avx -maes")
