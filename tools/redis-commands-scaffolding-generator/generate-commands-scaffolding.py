...
class Program:
    ...
    def _generate_command_data_struct_name(self, command_info: dict) -> str:
        return "module_redis_command_{command_callback_name}_data".format(**command_info)

    def _generate_command_data_typedef_name(self, command_info: dict) -> str:
    ...
    def _generate_commands_scaffolding_header_file_command_data_struct(self, command_info: dict) -> str:
        ...
        # data types
        # "key", "string", "integer", "pure-token", "oneof", "unix-time", "double", "pattern", "block"
        # parameters
        # "name", "type", "key_spec_index", "token", "optional", "arguments", "since", "multiple", "multiple_token"
    ...
    def _generate_commands_scaffolding_commands_header_command_callback(command_info: dict) -> str:
        return (
            "\n".join([
                ...
                "MODULE_REDIS_COMMAND_FUNCPTR_COMMAND_END_AUTOGEN({command_callback_name});",
    ...
    def _generate_commands_module_redis_commands_autogenerated_c(self, commands_info: list):
        with open(path.join(
            ...
            # TODO: add the necessary headers to allow the compilation
