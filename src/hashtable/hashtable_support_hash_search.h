...
#define HASHTABLE_SUPPORT_HASH_SEARCH_METHOD_SIZE_SIGNATURE(METHOD, SIZE) \
    extern hashtable_bucket_slot_index_t HASHTABLE_SUPPORT_HASH_SEARCH_METHOD_SIZE(METHOD, SIZE)( \
