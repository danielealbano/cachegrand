...
hashtable_bucket_slot_index_t hashtable_support_hash_search_loop_n(
...
hashtable_bucket_slot_index_t hashtable_support_hash_search_loop_14(
        hashtable_bucket_hash_half_t hash,
        hashtable_bucket_hash_half_atomic_t* hashes,
        uint32_t skip_indexes_mask) {
...
hashtable_bucket_slot_index_t hashtable_support_hash_search_loop_13(
        hashtable_bucket_hash_half_t hash,
        hashtable_bucket_hash_half_atomic_t* hashes,
        uint32_t skip_indexes_mask) {
...
hashtable_bucket_slot_index_t hashtable_support_hash_search_loop_8(
        hashtable_bucket_hash_half_t hash,
        hashtable_bucket_hash_half_atomic_t* hashes,
        uint32_t skip_indexes_mask) {
