...
#define TAG "module_redis_command_incr"

MODULE_REDIS_COMMAND_FUNCPTR_COMMAND_END(incr) {
    module_redis_command_incr_context_t *context = connection_context->command.context;
