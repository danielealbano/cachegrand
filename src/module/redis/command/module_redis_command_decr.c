...
#define TAG "module_redis_command_decr"

MODULE_REDIS_COMMAND_FUNCPTR_COMMAND_END(decr) {
    module_redis_command_decr_context_t *context = connection_context->command.context;
