...
#define TAG "module_redis_command_incrby"

MODULE_REDIS_COMMAND_FUNCPTR_COMMAND_END(incrby) {
    module_redis_command_incrby_context_t *context = connection_context->command.context;
