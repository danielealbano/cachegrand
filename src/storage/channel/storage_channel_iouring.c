...
storage_channel_iouring_t* storage_channel_iouring_new() {
    storage_channel_iouring_t *channel =
            (storage_channel_iouring_t*)fast_fixed_memory_allocator_mem_alloc_zero(sizeof(storage_channel_iouring_t));
...
storage_channel_iouring_t* storage_channel_iouring_multi_new(
    ...
    storage_channel_iouring_t *channels =
            (storage_channel_iouring_t*)fast_fixed_memory_allocator_mem_alloc_zero(sizeof(storage_channel_iouring_t) * count);
