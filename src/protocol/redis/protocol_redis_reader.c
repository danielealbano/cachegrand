...
//                context->arguments.list = fast_fixed_memory_allocator_mem_realloc(
...
//                    context->arguments.list[context->arguments.current.index].value = fast_fixed_memory_allocator_mem_realloc(
