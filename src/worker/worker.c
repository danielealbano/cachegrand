...
void worker_cleanup_general(
    ...
    if (worker_context->fibers.listeners_fibers) {
        fast_fixed_memory_allocator_mem_free(worker_context->fibers.listeners_fibers);
    }
}
...
void* worker_thread_func(
    ...
    worker_context->fibers.listeners_fibers = fast_fixed_memory_allocator_mem_alloc(sizeof(fiber_t*) * listeners_count);
