...
network_channel_iouring_t* network_channel_iouring_new(
    ...
    network_channel_iouring_t *channel =
            (network_channel_iouring_t*)fast_fixed_memory_allocator_mem_alloc_zero(sizeof(network_channel_iouring_t));
...
network_channel_iouring_t* network_channel_iouring_multi_new(
    ...
    network_channel_iouring_t *channels =
            (network_channel_iouring_t*)fast_fixed_memory_allocator_mem_alloc_zero(sizeof(network_channel_iouring_t) * count);
...
void network_channel_iouring_free(
    ...
    fast_fixed_memory_allocator_mem_free(network_channel);
}
