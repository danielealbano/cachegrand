...
#define NETWORK_CHANNEL_MAX_PACKET_SIZE     (32 * 1024)
#define NETWORK_CHANNEL_RECV_BUFFER_SIZE    (NETWORK_CHANNEL_MAX_PACKET_SIZE * 2)
#define NETWORK_CHANNEL_SEND_BUFFER_SIZE    (NETWORK_CHANNEL_MAX_PACKET_SIZE * 2)
