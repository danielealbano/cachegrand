...
hashtable_hash_t hashtable_mcmp_support_hash_calculate(
        hashtable_key_data_t *key, hashtable_key_size_t key_size);

hashtable_hash_half_t hashtable_mcmp_support_hash_half(
        hashtable_hash_t hash);

hashtable_hash_quarter_t hashtable_mcmp_support_hash_quarter(
